...
define('APP_ROOT_DIR', '/LAR/services'); //main folder which wraps complete application
...
define('META_TBO_BUS_COURSE','VHCID1433498607');
define('META_HOLIDAY_LIVE_COURSE','VHCID1433498322');
/*
 |--------------------------------------------------------------------------
...
define ('MYSTIFLY_LCC_FLIGHT_BOOKING_SOURCE', 'PTBSID0000000150' ); // MYSTIFLY  LCC Flight
define ('MYSTIFLY_REST_FLIGHT_BOOKING_SOURCE', 'PTBSID00000000045' ); // MYSTIFLY  REST Flight
...
define ('HB_HOTEL_BOOKING_SOURCE', 'PTBSID0000000013');//Hotel Beds hotel api
define('AGODA_HOTEL_BOOKING_SOURCE', 'PTBSID0000000016');//Agoda Hotel API
define('YATRA_HOTEL_BOOKING_SOURCE', 'PTBSID00000000044');//Yatra Hotel API
define('ETRAVELSMART_BUS_BOOKING_SOURCE', 'PTBSID0000000014');// etravel smart bus
define('TBO_BUS_BOOKING_SOURCE', 'PTBSID0000000126');// etravel smart bus
define('FLYINGROUPS_BOOKING_SOURCE', 'PTBSID0000000058');
...
define('CARNECT_CAR_BOOKING_SOURCE', 'PTBSID0000000017'); // Carnet Car
define('TRAVELPORT_MEELO_FLIGHT_BOOKING_SOURCE', 'PTBSID0000000030');// travelport meelotrip 
define('TBO_AIR_FLIGHT_BOOKING_SOURCE', 'PTBSID0000000031');// Tbo air booking source
define('AIRBLUE_FLIGHT_BOOKING_SOURCE', 'PTBSID0000000032');// Aibrblue Scrapping
define('CEBU_FLIGHT_BOOKING_SOURCE', 'PTBSID0000000034');// Cebu Scrapping
define('PK_FARE_FLIGHT_BOOKING_SOURCE', 'PTBSID0000000029');// pk fare flight
define('STTECH_AIRLINE_FLIGHT_BOOKING_SOURCE', 'PTBSID00000000040'); 
define('GOFLYSMART_FLIGHT_BOOKING_SOURCE', 'PTBSID0000000122');// GoFlySmart Sightseeing Source
define('RATEHAWK_HOTEL_BOOKING_SOURCE', 'PTBSID0000000121');// TBO Sightseeing Source
define('BOOKNTRAVEL_FLIGHT_BOOKING_SOURCE', 'PTBSID0000000124');
define('TRIPJACK_FLIGHT_BOOKING_SOURCE', 'PTBSID00000000041');  
define('AIRIQ_FLIGHT_BOOKING_SOURCE', 'PTBSID00000000043');  
define('SABRE_REST_FLIGHT_BOOKING_SOURCE', 'PTBSID00000000046');//Sabre REST Flight
define('YATRA_FLIGHT_BOOKING_SOURCE', 'PTBSID00000000047');//YATRA Flight
define('DIDA_HOTEL_BOOKING_SOURCE', 'PTBSID00000000048');//DIDA Hotel
define('TRAVELOGY_FLIGHT_BOOKING_SOURCE', 'PTBSID00000000049');//TRAVELOGY Flight
define('AIRIQ_API_FLIGHT_BOOKING_SOURCE', 'PTBSID00000000050');//AIRIQ API Flight
define('TRAVELOMATIX_FLIGHT_BOOKING_SOURCE', 'PTBSID00000000055'); //Travelomatix
define('AMADEUS_FLIGHT_BOOKING_SOURCE', 'PTBSID0000000123');  //Amadeus
...
define('BUS_VERSION_3', 3);
define('HOLIDAY_VERSION_1', 	1);
/*
 |--------------------------------------------------------------------------
