...
abstract class Common_Api_Hotel extends Common_Api_Grind {
	 ...
	 */
	protected function format_summary_array(int $journey_number,string $origin_code,string $destination_code,string $departure_dt,string $arrival_dt,string $operator_code,string $operator_name,string $hotel_number,int $no_of_stops,string $cabin_class = '',string $origine_name = '',string $destination_name = '',string $duration = '',bool $is_leg = true,array $attr = [],string $org_terminal = '',string $des_terminal = '',string $carrier_code = ''): array {
		$CI = & get_instance ();
	 ...
	 */
	protected  function is_active_booking_source(): array
	{
		$data = [];
