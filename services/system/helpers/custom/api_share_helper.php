...
{
	return '<a href="'.car_voucher_url($app_reference, $booking_source, $status).'/show_voucher" target="_blank" class="btn btn-sm btn-primary flight_v"><i class="fa fa-file-o"></i> Voucher</a>';
}
