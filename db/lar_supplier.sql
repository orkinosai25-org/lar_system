-- ============================================================
-- LAR System — lar_supplier database schema
-- Supplier Portal
...
-- Eco Stays (supplier-specific hotel sub-type)
CREATE TABLE IF NOT EXISTS `eco_stays_types` (
  `id`        INT UNSIGNED  NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `eco_stays_room_types` (
  `id`        INT UNSIGNED  NOT NULL AUTO_INCREMENT,
  `type_name` VARCHAR(100)  NOT NULL,
  `status`    TINYINT(1)    NOT NULL DEFAULT 1,
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `eco_stays_amenities` (
  `id`            INT UNSIGNED  NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `eco_stays_room_amenities` (
  `id`          INT UNSIGNED  NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `eco_stays_board_types` (
  `id`        INT UNSIGNED  NOT NULL AUTO_INCREMENT,
  `type_name` VARCHAR(100)  NOT NULL,
...
CREATE TABLE IF NOT EXISTS `eco_stays_room_meal_types` (
  `id`          INT UNSIGNED  NOT NULL AUTO_INCREMENT,
  `room_type_id` INT UNSIGNED NOT NULL,
