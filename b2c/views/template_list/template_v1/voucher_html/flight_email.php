...
table[class=sgsmal] tr, table[class=sgsmal] td{line-height: 12px; }
...
td[class=prstyle]{ float: left;
    ...
    width: auto !important;}
table[class=insidefull] .fullwdth{ display: block;
    overflow: hidden;
    width: 100% !important;text-align: center;border-bottom: 1px solid #dddddd;}
table[class=insidefull] .fullwdth:last-child{ border-bottom:none}
}
...
<table style="max-width:645px; margin:10px auto;border: 1px solid #dddddd;" class="devicewdt">
    	<tr>
        	<td style="padding:10px;">
                    	...
                    	<table style="width:100%">
                            <tr>
                                <td style="width:33.33%" class="logocvr">
                                     <img style="max-width:150px; height:80px;" src="images/logo.jpg" alt="" /> 
                                </td>
                                <td style="width:33.33%" class="prstyle">
                                    <img style="background-color: #eeeeee;border: 1px solid #dddddd;border-radius: 5px;display: block;margin: 0 auto;padding: 10px; cursor: pointer;" src="images/print.png" alt="" /> 
                                </td>
                	...
                	<td>
                    	<table style="width:100%" class="insideone">
                        	<tr>
                                ...
                                <td style="color:#333">CONFIRMED</td>
                            </tr>
                            <tr>
                            	<td>Confirmation No :</td>
                                <td style="color:#333">BOOK04H29135561</td>
                            </tr>
                            <tr>
                            	<td>Travelers :</td>
                                <td style="color:#333"><img style="height:15px" src="images/adult.png" alt="" /> 2 | <img style="height:15px" src="images/children.png" alt="" /> 1</td>
                            </tr>
                            <tr>
                            	<td>Class :</td>
                                <td style="color:#333">Economy</td>
                            </tr>
                            <tr>
                            	<td>Total Amount :</td>
                                <td style="color:#333">$2350</td>
                            </tr>
                        </table>
                    </td>
                </tr>
                ...
                <tr>
                	<td>
                    	<table style="width:100%; margin-top:15px; border:1px solid #ddd;" class="insideone">
                                	...
                                	<table style="width:100%;" class="insidefull">
                                    	<tr>
                                        	<td style="width:25%" class="fullwdth">
                                                <table style="width:100%;">
                                                    <tr>
                                                        <td style="text-align:right"><img alt="" src="images/smAI.gif"></td>
                                                        <td>
                                                            <table class="sgsmal">
                                                                <tr><td style="padding-bottom: 5px;">SpiceJet</td></tr>
                                                                <tr><td style="font-size:10px; color:#999;">SG-13 Boeing</td></tr>
                                                            </table>
                                                        </td>
                                                    </tr>
                                                </table>
                                                ...
                                                <table style="width:100%">
                                                    <tr>
                                                        <td style="width:41.66%;">
                                                        	<table style="width:100%">
                                                            	<tr>
                                                                	 <td style="font-size:14px; color:#444; font-weight:bold;">Mumbai (BOM)</td>             
                                                                </tr>
                                                                <tr><td>26 Jun, 08:30</td></tr>
                                                            </table>
                                                        </td>
                                                        <td style="width:16.66%">
                                                        	<img style="width: 30px;" alt="" src="images/right_arrow.png">
                                                        </td>
                                                        <td style="width:41.66%;">
                                                        	<table style="width:100%">
                                                            	<tr>
                                                                	 <td style="font-size:14px; color:#444; font-weight:bold;">Dubai (DXB)</td>             
                                                                </tr>
                                                                <tr><td>26 Jun, 08:30</td></tr>
                                                            </table>
                                                        </td>
                                            ...
                                            <td style="width:16.66%; text-align:center" class="fullwdth">
                                                3h 35m<br>Non Stop
                                            </td>
                                        </tr>
                                    </table>
                    ...
                    <td>
                        <table  style="width:100%" class="insideone">
                            <tr>
                                ...
                                <td style="color:#333">provab@gmail.com</td>
                            </tr>
                            <tr>
                                <td>Mobile Number  :</td>
                                <td style="color:#333">0123456789</td>
                            </tr>
                            <tr>
                                <td>Address :</td>
                                <td style="color:#333">Electronic city , Karnataka, Bangalore, 560100</td>
                            </tr>
                        </table>
                    </td>
                </tr>
                ...
                <tr>
                    <td style="padding-bottom:10px; text-align:justify;">
                        <strong>Flight</strong> - We're here to help! If you need assistance with your reservation, please visit our Help Center. For urgent situations,: such as check-in troubles or arriving to something unexpected 
                    </td>
                </tr>
                <tr>
                    <td style="padding-bottom:10px; text-align:justify;">
