    	...
    	<tr>
        	<td style="padding:10px;">
            	<table style="width:100%; color:#666; font-size:13px;font-family: arial,serif;line-height: 22px;">
                    ...
                    <tr>
                        <td style="border-bottom: 1px solid #dddddd;color: #444444;display: block;font-size: 18px;margin: 10px 0 15px;overflow: hidden;padding: 10px 0;">
                            Electronic City Bangalore, Bengaluru, India
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td>
                            <table style="width:100%" class="insideone">
                                ...
                                <tr>
                                    <td>Check-in :</td>
                                    <td style="color:#333">21 Oct 2015</td>
                                </tr>
                                <tr>
                                    <td>Check-out :</td>
                                    <td style="color:#333">22 Oct 2015</td>
                                </tr>
                                <tr>
                                    <td>
                                        <table style="width:100%" class="insideone">
                                            <tbody>
                                                ...
                                                <tr style=" border: 1px solid #dddddd;">
                                                    <td style="font-size: 28px;font-weight: bold;text-align: center; padding:15px 0;">$2830</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </td>
