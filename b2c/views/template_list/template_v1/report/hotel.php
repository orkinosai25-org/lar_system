						...
						<?php
							if (isset($table_data) == true and valid_array($table_data)) {
								...
								foreach($table_data as $k => $v) {
									...
									//$action .= hotel_email_voucher($v['app_reference'], $booking_source, $v['status']);
									...
									$action .='<div class="col-md-2 pull-right pad0">
												...
												<ul class="dropdown-menu booking_list1" aria-labelledby="dLabel1">
													...
													<li>
														<a href="'.base_url().'index.php/report/hotel_booking_details/?app_reference='.$v['app_reference'].'&reference_id='.$v['booking_source'].'&status='.$v['status'].'" target="_blank">
															<div class="img_mb1">
