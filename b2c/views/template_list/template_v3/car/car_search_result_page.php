...
<div class="car_sec">
 ...
 foreach($raw_car_list['CarSearchResult']['CarResults'] as $car_key => $car_details) {
  ...
  if(isset($car_details) && valid_array($car_details)) {
     $PickUpLocationCode = isset($car_details['PickUpLocationCode']) ? $car_details['PickUpLocationCode'] : null;
    $ReturnLocationCode = isset($car_details['ReturnLocationCode']) ? $car_details['ReturnLocationCode'] : null;			
      $AirConditionInd   = $car_details['AirConditionInd']   ?? null;
      $TransmissionType  = $car_details['TransmissionType']  ?? null;
      $FuelType          = $car_details['FuelType']          ?? null;
      $DriveType         = $car_details['DriveType']         ?? null;
      $PassengerQuantity = $car_details['PassengerQuantity'] ?? null;
      $BaggageQuantity   = $car_details['BaggageQuantity']   ?? null;
      $VendorCarType     = $car_details['VendorCarType']     ?? null;
      $Code              = $car_details['Code']              ?? null;
      $CodeContextType   = $car_details['CodeContext']       ?? null;
      $DoorCount         = $car_details['DoorCount']         ?? null;
      $car_type          = $car_details['VehicleCategory']   ?? null;
      $car_type_name     = $car_details['VehicleCategoryName'] ?? null;
      $car_class         = $car_details['VehClassSizeName']  ?? null;
      $car_class_id      = $car_details['VehClassSize']      ?? null;
      $car_name          = $car_details['Name']              ?? null;
      $car_image         = $car_details['PictureURL']        ?? null;

      // Nested arrays with safe checks
      $supplier_logo     = $car_details['TPA_Extensions']['SupplierLogo']     ?? null;
      $TotalAmount       = $car_details['TotalCharge']['EstimatedTotalAmount'] ?? null;
      $OnewayTotalFare   = $car_details['TotalCharge']['OneWayFee']           ?? null;
      $ID_Context        = $car_details['Reference']['ID_Context']            ?? null;
      $Type              = $car_details['details']['Reference']['Type']       ?? null;
      $Vendor            = $car_details['Vendor']                             ?? null;
      $vehicle_package   = $car_details['RateComments']                       ?? null;
      $VendorLocation    = $car_details['VendorLocation']                     ?? null;
      $DropOffLocation   = $car_details['DropOffLocation']                    ?? null;
      $oneway_fee ='';
      $mileagetype = 'Limited' ;
    ...
    <div class="madgrid forhtlpopover">
     <div class="col-xs-12 nopad">
      <div class="sidenamedesc mobile_f_i">
       <div class="celhtl width40 midlbord">
        ...
        <div class="waymensn">
         <div class="flitruo_hotel">
          <div class="hoteldist"> 
           ...
           <div class="clearfix"></div>
           <span class="hotel_address elipsetool hide"><?=$CodeContextType?></span>
           <div class="clearfix"></div>
           ...
           <div class="pick cr_wdt"><span>Vehicle:</span><strong><?=ucwords(@$car_type_name);?></strong>
           </div>
           ...
           <div class="middleCol">
            <ul class="features">
             <li class="person tooltipv">
              <a title="Passengers">
               <?php if(isset($PassengerQuantity) && !empty($PassengerQuantity)){ ?><span class="cr_icn c_seat"></span> <strong><?=$PassengerQuantity?> Seats</strong> <span class="hide passenger_quantity"><?=$PassengerQuantity?></span> <?php } ?>
              </a>
             </li>
              <li class="person tooltipv">

              <a href="#" title="<?=$fuel_policy_desc?>">

              <span class="cr_icn c_fuel"></span>
             ...
             <li class="baggage tooltipv">
              ...
              <a  title="Bags">
               ...
               <?php if(isset($BaggageQuantity) && !empty($BaggageQuantity)){ ?><span class="mn-icon"></span><strong><?=$BaggageQuantity?> Bags</strong> <?php } ?>
             ...
             <li class="doors tooltipv">
              ...
              <a  title="Doors">
               ...
               <?php if(isset($DoorCount) && !empty($DoorCount)){ ?><span class="mn-icon"></span><strong><?=$DoorCount?> Doors</strong> <span class="hide door_count"><?=$DoorCount?></span> <?php } ?>
        ...
        <div class="width20 mobile_f_i">
         ...
         <div class="mrinfrmtn">
          <div class="sidepricewrp">
           ...
           <div class="c_per_day hide">per day</div>
          <?php 
          $policy_text ='';
         ...
         <?php } ?>
          <!-- <span class="text-center non_ref" style="color:#0B9FD1; display: block;">Cancellation Policy</span> -->
           ...
           <a class="detailsflt" data-toggle="collapse" data-target="#car_rental<?=$car_key?>">View&nbsp;<label>Details</label><span class="caret"></span>
          </a>
         </div>
        </div>
      </div>
