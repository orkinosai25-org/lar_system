                    ...
                    <div class="container">
                        <div class="topalstn">
                            <div class="socila hidesocial">
                                ...
                                $temp = $this->custom_db->single_table_records('social_links','*',array('status' => 1),0,10,array('orders' =>'ASC'));
            ...
            <footer>
                <div class="fstfooter">
                    <div class="">
                        <div class="reftr">
                        <div class="container">
                            <div class="col-xs-12 col-sm-4 nopad fulnine hide">

                                <div class="col-md-12 nopad">
                                     <img
                                        src="<?php echo $GLOBALS['CI']->template->template_images('footer_logo.png'); ?>"
                                        ...
                                        <?php echo @$domain_data['data'][0]['address']; ?>

                                    </div>
                                </div>
                            </div>
                            <div class="col-xs-12 fulnine color_bg nopad">
                                <div class="col-xs-4 col-sm-4 nopad">
                                    <div class="frtbest us_lnk">
                                        <ul id="accordionfot1" class="accordionftr">
                                            <h4 class="ftrhd arimo ">USEFUL LINKS</h4>
                                            <ul class="submenuftr1">
												<li class="frteli"><a href="https://www.travelsoho.com/LAR">Home</a></li>
                                                <?php
                                                $cond = array(
                                                    'page_status' => ACTIVE,
													'page_keyword' => 'useful'
                                                );
                                                $cms_data = $this->custom_db->single_table_records('cms_pages', '', $cond,0, 4, array('orders' => 'ASC'));
                                                //debug($cms_data);exit;
                                                ...
                                                ?>
                                                <li class="frteli"><a href="#">Rooms</a></li>
												<li class="frteli"><a href="<?php echo base_url().'index.php/report/cancel_booking';?>">Cancel Booking</a></li>
                                            </ul>
                                        </ul>
                                    </div>
                                </div>
                                <div class="col-xs-4 nopad">
                                    <div class="frtbest legl">
                                        <ul id="accordionfot" class="accordionftr">
                                            <h4 class="ftrhd arimo ">Legal Links</h4>
                                ...
                                <div class="col-md-4 col-xs-4 nopad subscribe">
                                    <div class="frtbest subs">
                                    <h4 class="ftrhd arimo ">SUBSCRIBE</h4>
                                    <!-- <p>Don’t miss to subscribe our news, kindly fill the form bellow</p> -->
                                <div class="signfomup">
                                    <div class="formbtmns">
                                        <input type="text" name="email" id="exampleInputEmail1" class="form-control ft_subscribe" value="" required="required" placeholder="Your Email Here">
                                    <button type="button" class="btn btn_sub subsbtm" onclick="check_newsletter()"><i class="far fa-chevron-right"></i></button>
                                    </div>
                                <span class="msgNewsLetterSubsc12" style="font-size: 13px; color: #fff; display: none;"><b>Please Provide Valid Email ID</b></span> <span class="succNewsLetterSubsc" style="font-size: 13px; color: #fff; display: none;"><b>Thank you for subscribe.We will be in touch with newsletter.</b></span> <span class="msgNewsLetterSubsc" style="font-size: 13px; color: #fff; display: none;"><b>You are already subscribed to Newsletter feed.</b></span> <span class="msgNewsLetterSubsc1" style="font-size: 13px; color: #fff; display: none;"><b>Activated to Newsletter feed.Thank you</b></span> 
                    ...
                    <div class="container">
                        ...
                        <div class="acceptimg">
                         ...
                         <ul class="signupfm">
                                    ...
                                    foreach($temp['data'] as $social_key => $social_links){ 
                                        $url = $social_links['url_link'];
                                        if($social_links['social'] == 'facebook'){
                                            $icon = 'faftrsoc fab fa-facebook-f';
                                        }
                                        else if($social_links['social'] == 'linkedin'){
                                            $icon = 'faftrsoc fab fa-linkedin';
                                        }
										 else if($social_links['social'] == 'instagram'){
                                            $icon = 'faftrsoc fab fa-instagram';
                                        }
                                        else if($social_links['social'] == 'twitter'){
                                            $icon = 'faftrsoc fab fa-twitter';
                                        }
                                        else if($social_links['social'] == 'youtube'){
                                            $icon = 'faftrsoc fab fab fa-youtube';
                                        }
                ...
                <div class="copyrit">&copy; <?php echo date('Y') ?><a target="_blank" href="<?= HEADER_DOMAIN_WEBSITE?>"> <?= HEADER_DOMAIN_NAME ?></a> All Rights Reserved.
                </div>
            </footer>
            <!-- Footer End -->
        </div>
