...
if(isset($active_booking_source) && valid_array($active_booking_source)) {
    foreach($active_booking_source as $act_k => $boking_src) {
        ...
        $source_ids[] = $boking_src['source_id'];
   
    $acitve_booking_sources = http_build_query(array('source_id' => $source_ids));
    // debug($acitve_booking_sources);die;
    ?><script>
        ...
        <div class="resultalls">
            ...
            <div class="coleft" id="coleftid">
                <div class="flteboxwrp">
                    ...
                    <div class="filtersho">
                        <div class="avlhtls"><strong id="filter_records"></strong> <span class="hide"> of <strong id="total_records"><?php echo $mini_loading_image ?></strong> </span> <span id="hotel_found_text"></span>
                        </div>
                            ...
                            <div class="dropdown-menu">
                                <div class="form-group">
                                    <div class="form-check">
                                      <input class="form-check-input star-h-2-l" data-order="desc" type="radio" name="filter" id="exampleRadios1" value="Recommended">
                                      <label class="form-check-label" for="exampleRadios1">Recommended</label>
                                    </div>  
                                </div>                              
                                <div class="form-group">
                                    <div class="form-check">
										 ...
										 <input type="radio" id="exampleRadios2" class="form-check-input deal-status-filter" name="filter" value="Best Value">
                                        <label class="form-check-label" for="exampleRadios2">Best Value</label>
                                    </div> 
                                </div>
                                <div class="form-group">
                                    <div class="form-check">
                                        <input class="form-check-input price-l-2-h" data-order="asc" type="radio" name="filter" id="exampleRadios3" value="Price (Lowest)">
										
                                        <label class="form-check-label" for="exampleRadios3">Price (Lowest)</label>
                                    </div> 
                                </div>
                                <div class="form-group">
                                    <div class="form-check">
                                        <input class="form-check-input price-h-2-l des" data-order="desc" type="radio" name="filter" id="exampleRadios4" value="Price (Highest)">
                                        <label class="form-check-label" for="exampleRadios4">Price (Highest)</label>
                                    </div> 
                                </div>
                                <div class="form-group">
                                    <div class="form-check">
                                        <input class="form-check-input star-h-2-l" type="radio" name="filter" id="exampleRadios5" value="Customer Rating (Highest)">
                                        <label class="form-check-label" for="exampleRadios5">Customer Rating (Highest)</label>
                                    </div> 
                                </div>
                            </div>
                          </div>
...
<div id="empty-search-result" class="container" style="display:none">
    <div class="jumbotron">
