...
function get_booking_details($booking_details)
{
	...
	// Always append fallback block; it will only be shown if the first block wasn't added
	if (!valid_array($booking_details)) {
...
function hotel_menu($booking_details,$customer_email){
	$v_val = array();
	$v_val['app_reference'] = $booking_details['app_reference'];
	$v_val['booking_source'] = $booking_details['booking_source'];
	$v_val['status'] = $booking_details['status'];
	$action ='<div class="col-md-2 pull-right pad0">
			...
			<ul class="dropdown-menu booking_list1" aria-labelledby="dLabel1">
				...
				<li class="load_mail_ticket_modal" data-reference_id="'.$v_val['booking_source'].'" data-app_reference="'.$v_val['app_reference'].'" data-status="'.$v_val['status'].'" data-customer_email="'.$customer_email.'">
						<div class="img_mb1">
							<img src="'.$GLOBALS['CI']->template->template_images('icons/email.png').'" />
						</div>
						<div class="all-type-img1">Email Voucher</div>
				</li>
				<li class="print_ticket" data-reference_id="'.$v_val['booking_source'].'" data-app_reference="'.$v_val['app_reference'].'" data-status="'.$v_val['status'].'">
						<div class="img_mb1">
							<img src="'.$GLOBALS['CI']->template->template_images('icons/print.png').'" />
						</div>
						<div class="all-type-img1">Print Voucher</div>
				</li>
				<li class="print_invoice" data-reference_id="'.$v_val['booking_source'].'" data-app_reference="'.$v_val['app_reference'].'" data-status="'.$v_val['status'].'">
						<div class="img_mb1">
							<img src="'.$GLOBALS['CI']->template->template_images('icons/print.png').'" />
						</div>
