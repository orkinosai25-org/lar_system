...
foreach ($raw_hotel_list['HotelSearchResult']['HotelResults'] as $hd_key=> $hd) {
	...
	if (is_array($hd) && isset($hd['booking_source']) && $hd['booking_source'] === 'PTBSID0000000011') {
			...
			<div class="sidenamedesc">
					...
					<div class="innd">
					   <div class="imptpldz">
						<div class="property-type" data-property-type="hotel"></div>
				      	<img class="htl_logo hide" src="<?=$GLOBALS['CI']->template->domain_images('htl_logo.png')?>" alt="img/jpg" />
				...
				<div class="celhtl width30">
					<div class="sidepricewrp">
				      	<!-- <span class="cart"><img  src="<?=$GLOBALS['CI']->template->template_images('lock.svg')?>" alt="img/jpg" /></span> -->			
