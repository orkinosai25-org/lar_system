...
<div class="container-fluid pad0">
	<div style="width:100%; float:left;">
		...
		<div class="hotel_voucher_main_tab" style="float:left; width:75%;">
			<h5 style="margin:0; font-size:13px;"><span style="color:#666; font-family:Arial, Helvetica, sans-serif;">Booking ID :</span> <?php echo $booking_id;?></h5>
		...
		function get_booking_details($booking_details)
{
	...
	if (valid_array($booking_details)) {
		$api_booking_id = $booking_details['booking_reference'];
		$confirm_number = $booking_details['confirmation_reference'];
		$lead_pax_detail = $booking_details['lead_pax_details'];
		$lead_pax_name = $lead_pax_detail['name'];
		$check_in = $booking_details['hotel_check_in'];
		$check_out = $booking_details['hotel_check_out'];
		$room_count = count($booking_details['itinerary_details']);
		$booking_status = $booking_details['status'];
		...
		$api_booking_details .= '<div style="width:100%; float:left;">
			<p style="word-break: break-all; text-align: justify; margin: 0; color: #646464;"><b>HOTEL BOOKING-ID:</b> '.$api_booking_id.' </p>
			<p style="word-break: break-all; text-align: justify; margin: 0; color: #646464;"><b>CONFIRMATION-NUMBER:</b> '.$confirm_number.'</p>
			<p style="word-break: break-all; text-align: justify; margin: 0; color: #646464;"><b>BOOKING STATUS:</b> '.$booking_status.'</p>
			<p style="word-break: break-all; text-align: justify; margin: 0; color: #646464;"><b>GUEST NAME:</b> '.$lead_pax_name.'</p>
			<p style="word-break: break-all; text-align: justify; margin: 0; color: #646464;"><b>ADULT (S):</b> '.$adult_count.'</p>
			<p style="word-break: break-all; text-align: justify; margin: 0; color: #646464;"><b>CHILDERN (S):</b> '.$child_count.'</p>
			<p style="word-break: break-all; text-align: justify; margin: 0; color: #646464;"><b>CHECK IN:</b> '.$check_in.'</p>
			<p style="word-break: break-all; text-align: justify; margin: 0; color: #646464;"><b>CHECK OUT:</b> '.$check_out.'</p>
			<p style="word-break: break-all; text-align: justify; margin: 0; color: #646464;"><b>ROOMS:</b> '.$room_count.' Room(s)</p>
			<p style="word-break: break-all; text-align: justify; margin: 0; color: #646464;"><b>NIGHTS:</b> '.get_date_difference($check_in, $check_out).' Nights </p>
		</div>';
	}

	if (!valid_array($booking_details)) {
		$api_booking_details .= '<div class="col-md-3">
			<p style="word-break: break-all; text-align: justify; margin: 0; color: #646464;">Not Available</p>
		</div>';
	}
	...
	function get_rooms_details($booking_details)
{
	...
	if (valid_array($booking_details)) {
		...
		foreach ($itinerary_details as $k => $v) {
			$smoking_preference = get_smoking_preference($v['smoking_preference']);
			$room_booking_details .= '<p style="word-break: break-all;
			text-align: justify;
			margin: 0;
			color: #646464;">Room ' . ($k + 1) . ') ' . $v['room_type_name'] . ', Smoking Preference : ' . $smoking_preference['label'] . '</p>';
		}
		$room_booking_details .= '</div>';
	}

	$is_empty = !valid_array($booking_details);
	$room_booking_details .= $is_empty ? '<div class="col-md-3">
	<p style="word-break: break-all;
	text-align: justify;
	margin: 0;
	color: #646464;">Not Available</p>
</div>' : '';
	...
	function get_customer_details($booking_details)
{
	...
	if (valid_array($booking_details)) {
		...
		$cus_booking_details .= '<div style="width:100%; float:left;">
			<p style="word-break: break-all; text-align: justify; margin: 0; color: #646464;"><b>User Name:</b> ' . $lead_pax_name . ' </p>
			<p style="word-break: break-all; text-align: justify; margin: 0; color: #646464;"><b>Email ID:</b> ' . $lead_pax_email . '</p>
			<p style="word-break: break-all; text-align: justify; margin: 0; color: #646464;"><b>Address:</b> ' . $attributes['address'] . '</p>
			<p style="word-break: break-all; text-align: justify; margin: 0; color: #646464;"><b>City:</b> ' . $attributes['billing_city'] . '</p>
			<p style="word-break: break-all; text-align: justify; margin: 0; color: #646464;"><b>Country:</b> ' . $attributes['billing_country'] . '</p>
			<p style="word-break: break-all; text-align: justify; margin: 0; color: #646464;"><b>Zip Code:</b> ' . $attributes['billing_zipcode'] . '</p>
		</div>';
	}
...
function ge_hotel_details($booking_details)
{
	...
	if (valid_array($booking_details)) {
		...
		$details .= '<div style="width:100%; float:left;">
			<p style="word-break: break-all; text-align: justify; margin: 0; color: #646464; font-family:Arial, Helvetica, sans-serif;">
				<b>' . $hotel_name . '</b>
	...
	if (!valid_array($booking_details)) {
		$details .= '<div class="col-md-3">
			<p style="word-break: break-all; text-align: justify; margin: 0; color: #646464; font-family:Arial, Helvetica, sans-serif;">Not Available</p>
		</div>';
	}
...
function get_passenger_count_detail($booking_details, $type = "passenger")
{
	...
	foreach ($booking_details['customer_details'] as $k => $v) {
		...
		$passengers .= '<p style="word-break: break-all; text-align: justify; margin: 0; color: #646464;">';
		$passengers .= ($k + 1) . ') ' . $v['name'];
		$passengers .= '</p>';
	}
