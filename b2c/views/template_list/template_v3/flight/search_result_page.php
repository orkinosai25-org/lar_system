...
<section class="search-result onlyfrflty">
		...
		<div class="resultalls">
			...
			<div class="colrit">
				<div class="insidebosc">
							...
							<div class="farenewcal">
								<div class="matrx">
									<div id="farecal" class="owl-carousel matrixcarsl">
										<!--<div class="item"><div class="fr_day">Tue, 19 Nov <strong>$345</strong></div></div>-->
					...
					?>
					<div class="filterforall <?=$round_way_trip_filter?> hide" id="top-sort-list-wrapper">
						<div class="topmisty" id="top-sort-list-11">
							<div class="col-xs-12 nopad">
								<div class="divinsidefltr">
									<div class="insidemyt col-xs-12 nopad">
										<?php
                                            ...
                                            <?php if($flight_search_params['trip_type_label']=="Round Wayddd" && $flight_search_params['is_domestic']==true) { ?>
	...
	<div class="container">
	<div id="empty-search-result" class="jumbotron no_rslt" style="display:none">
