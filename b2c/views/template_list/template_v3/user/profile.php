		...
		<div class="smlwel">All your trips booked with us will appear here and you'll be able to manage everything!</div>
			<div class="bokinstts">
				...
				<div class="ritlstxt">
					...
					<span class="witbook far fa-plane"></span> <a href="<?=base_url().'index.php/report/flights?default_view='.META_AIRLINE_COURSE?>" class="htview"> View detail <span class="far fa-arrow-right"></span> </a> </div>
				</div>
				<div class="col-xs-3 nopad">
				...
				<div class="ritlstxt">
					...
					<span class="witbook far fa-bed"></span> <a href="<?=base_url().'index.php/report/hotels?default_view='.META_AIRLINE_COURSE?>" class="htview"> View detail <span class="far fa-arrow-right"></span> </a> </div>
				</div>
				
				<div class="col-xs-3 nopad hide">
				<div class="insidebx color3">
				<div class="ritlstxt">
					<div class="contbokd">
						<?=$booking_counts['bus_booking_count']?>
					</div>Buses booked </div>
				<span class="witbook far fa-bus"></span> <a href="<?=base_url().'index.php/report/buses?default_view='.META_BUS_COURSE?>" class="htview"> View detail <span class="far fa-arrow-right"></span> </a> </div>
				</div>
				...
				<span class="witbook far fa-taxi"></span> <a href="<?=base_url().'index.php/report/transfers?default_view='.META_TRANSFERV1_COURSE?>" class="htview"> View detail <span class="far fa-arrow-right"></span> </a> </div>
				</div>
				<?php endif;?>
				...
				<span class="witbook far fa-binoculars"></span> <a href="<?=base_url().'index.php/report/activities?default_view='.META_SIGHTSEEING_COURSE?>" class="htview"> View detail <span class="far fa-arrow-right"></span> </a> </div>
				</div>
			<?php endif;?>
			<?php if(is_active_car_module()):?>
				...
				<span class="witbook far fa-taxi"></span> <a href="<?=base_url().'index.php/report/car?default_view='.META_CAR_COURSE?>" class="htview"> View detail <span class="far fa-arrow-right"></span> </a> </div>
				</div>
			<?php endif;?>
			</div>
			</div>
			...
			<div class="col-xs-6 nopad full_nty">
				...
				<h4 class="dskrty">Recent Acivities</h4>
					...
					<a target="_blank" href="<?=base_url();?>index.php/voucher/<?=$lt_v['transaction_type']?>/<?=$lt_v['app_reference']?>/<?=$boking_source?>">
						...
						<div class="lofa2 far fa-<?=$icon?>"></div>
						</div>
					...
					<div class="infowone">
						...
						<div class="col-xs-3 margpas">
							...
							<div class="lablmain cellpas">
								...
								<option value = '<?=$mobile_code?>' ><?=$mobile_code?></option>
								<?=generate_options($phone_code_array, (array)$mobile_code)?>
								</select>
							</div>
							</div>
						</div>
					...
					<div class="othinformtn">
						...
						<div class="tab-pane active" role="tabpanel">
							...
							<form action="<?=base_url().'index.php/user/add_traveller?active=traveller'?>" method="post" name="add_traveller_form" id="add_traveller_form" autocomplete="off">
								...
								<div class="col-xs-4 margpas">
									<div class="tnlepasport">
									<div class="paspolbl cellpas">DOB <span class="text-danger">*</span></div>
									<div class="lablmain cellpas">
					...
					<div class="othinformtn">
						...
						<div role="tabpanel" class="tab-pane active" id="traveller_user_details<?=$traveller_k?>">
							...
							<div class="paspertorgnl paspertedit">
								...
								<div class="col-xs-4 margpas">
								<div class="tnlepasport">
									<div class="paspolbl cellpas">DOB <span class="text-danger">*</span></span></div>
									<div class="lablmain cellpas">
