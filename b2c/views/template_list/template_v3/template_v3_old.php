    ...
    <body class="<?php echo (isset($body_class) == false ? 'index_page' : $body_class) ?>">
        ...
        <div class="allpagewrp">
            ...
            <footer>
                        ...
                        <div class="container">
                         ...
                         <div class="col-md-12 col-xs-12 sign_bg">
                                    <div class="frtbest1 centertio">
                                         <div class="col-md-4 col-xs-5 nopad">
                                         <h2>Keep yourself updated!</h2>
                                            <h4 class="sub_news">Subscribe to our Newsletter</h4>
                                            </div>
                                        <div class="col-md-6 col-xs-7 nopad">
                                        <div class="signfomup">
                                            <div class="formbtmns">
                                        ...
                                        <img src="<?php echo $GLOBALS['CI']->template->template_images('e_mail.png'); ?>" alt="" />
                                        </div>
                                        ...
                                        <ul id="accordionfot1" class="accordionftr">
                                            ...
                                            <ul class="submenuftr1">
                                                ...
                                                foreach ($master_module_list as $k => $v) {
                                                    if (in_array($k, $active_domain_modules)) {
                                                        ?>
                                                        <li class="frteli"><a href="<?php echo base_url() ?>general/index/<?php echo ($v) ?>?default_view=<?php echo $k ?>"><?php echo ucfirst($v); ?></a>
                                                        </li>
                                                        <?php
                                                    }
                                                }
                                                ?>
                                                <li class="frteli"><a href="<?php echo base_url() ?>/index.php/report/print_voucher">Print Voucher</a></li>
                                            </ul>
                                        </ul>
                                    </div>
                                </div>
                         ...
                         <ul class="signupfm">
                                    ...
                                    foreach($temp['data'] as $social_key => $social_links){ 
                                        ...
                                        if($social_links['social'] == 'facebook'){
                                            ...
                                            $icon = 'faftrsoc fab fa-google-plus-g';
                                        }
                                        else if($social_links['social'] == 'twitter'){
                                    ...
                                    <a href="<?php echo $url; ?>" target="_balnk"><i class="<?php echo $icon; ?>"></i></a>
                                   <?php  }
                                } ?>
                           </ul>
                ...
                <div class="copyrit">
                           Copyright &copy; <?php echo date('Y') ?><a target="_balnk" href="<?= HEADER_DOMAIN_WEBSITE?>"> <?= HEADER_DOMAIN_NAME ?></a> All rights reserved.
                </div>
            </footer>
            <!-- Footer End -->
        </div>
