...
<div class="content-wrapper dashboard_section">
	...
	<?php if (empty($print_voucher) || $print_voucher !== 'yes') {
    echo $GLOBALS['CI']->template->isolated_view('share/profile_navigator_tab');
} ?>

<div class="bakrd_color">
				<div class="cetrel_all">
					<?php if (empty($print_voucher) || $print_voucher !== 'yes') {
    echo $GLOBALS['CI']->template->isolated_view('share/navigation');
} ?>
