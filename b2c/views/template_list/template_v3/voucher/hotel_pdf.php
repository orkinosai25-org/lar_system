   ...
   <td style="border-collapse: collapse; padding:10px 20px 20px" ><table width="100%" style="border-collapse: collapse;" cellpadding="0" cellspacing="0" border="0">
           ...
           <tr>
            ...
            <tr><td style="line-height:6px;">&nbsp;</td></tr>                  
              ...
              <tr><td align="center" style="border-bottom:1px solid #999999;padding-bottom:15px"><span style="font-size:10pt; color:#555;">Customer Contact Details | E-mail : <?=$customer_details[0]['email']?> | Contact No :<?=$customer_details[0]['phone_code']?> <?=$customer_details[0]['phone']?></span></td></tr>
              <tr><td style="line-height:2px;">&nbsp;</td></tr>
              <tr>
              ...
              <tr>
                <td style="border-bottom:1px solid #999999; padding-bottom:15px; font-size:9pt; color:#555;line-height:16px"><?php echo $data['terms_conditions']; ?>
                    </td>
              </tr>
              <tr><td style="line-height:2px;">&nbsp;</td></tr>
              <tr>
