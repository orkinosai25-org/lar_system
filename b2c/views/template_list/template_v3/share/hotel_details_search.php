...
$radius ='';
$location ='';
if(isset($hotel_search_params['search_type']) && $hotel_search_params['search_type'] == 'location_search'){
	$loc_div_style = '';
...
// echo debug($hotel_search_params);exit;
?>
<form name="hotel_search" id="hotel_search" autocomplete="on" action="<?php echo base_url().'index.php/general/pre_hotel_details_search' ?>">
		...
		<div class="tabrow">
			<div class="col-lg-4 col-md-3 col-sm-6 col-xs-5 padfive full_clear">
				<div id="citysearch" <?php echo $city_div_style; ?>>	
					...
					<input class="hide" name="hotelcode" type="hidden" value="<?=@$HotelCode?>" >
					</div>
				</div>
				...
				<div class="pull-left location-search" id="locationsearch">
					...
					<div class="plcetogo nitmark selctmark sidebord">
						<select class="normalsel padselct arimo" id="nationality">
							<?php
								
								/*foreach ($hotelcountries as $country) {
									if ($i == $no_of_days) {
									...
									?>
									<option <?=$selected?> value="<?php $country['country_code'];?>"><?=$country['country_name']?></option>
							<?php
								}*/
							?>
						</select>
			...
			<div class="col-lg-3 col-md-4 col-sm-6 col-xs-7 nopad full_clear">
				<div class="col-md-6 col-xs-6 padfive br_rt">
			...
			<div class="col-md-5 col-xs-12 nopad">
				<div class="col-md-3 col-sm-4 col-xs-4 mobile_width padfive br_rt">
				...
				<div class="col-md-6 col-sm-4 col-xs-4 mobile_width padfive">
					<div class="lablform">Rooms &amp; Guests</div>
					<div class="totlall">
						...
						<div class="roomcount">
							...
							?>
								...
								<div class="mobile_adult_icon">Travellers<i class="fa fa-male"></i></div>
									...
									<div class="roomrow">
										<div class="celroe col-xs-4">Adults<br><span class="agemns">(17+)</span></div>
									...
									<div class="roomrow">
										<div class="celroe col-xs-4">Children<br><span class="agemns">(0-17)</span></div>
										<div class="celroe col-xs-8">
											<div class="input-group countmore pax-count-wrapper">
												<span class="input-group-btn">
										...
										<div data-child="<?=$child?>" data-currnet="<?=$current_room_child_count?>" class="col-xs-6 padfive child-age-wrapper-<?=$child?>" style="<?=$child_age_visibility?>">
											...
											<div class="plcetogo selctmarksml">
												<select name="childAge_<?=$room?>[]" class="normalsel padselctsmal arimo">
													<?=generate_options(numeric_dropdown_age(array('size' => 17)), array($child_age_value))?>
												</select>
											</div>
											</div>
										</div>
				...
				<div class="col-md-3 col-sm-4 col-xs-4 mobile_width padfive">
					...
					<div class="searchsbmtfot">
						<input type="submit" id="hotel-form-submit" class="searchsbmt" value="" /><i class="far fa-search"></i>
					</div>
				</div>
			</div>
		</div>
