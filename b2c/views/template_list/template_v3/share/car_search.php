...
<form id="trasfer" name="car" autocomplete="off" action="<?=base_url()?>index.php/general/pre_car_search">
	<div class="tabspl forbusonly car_form">
		<div class="clearfix"></div>
		<div class="outsideserach custom_divclass">
			<div class="clearfix"></div>
			<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 nopad cr_plce placerows br_rt">
			...
			<div class="col-md-6 col-xs-12 nopad br_rt">
			  ...
			  <div class="col-md-6 col-xs-12 nopad">
				...
				<div class="col-xs-4 padfive">					
						<span class="formlabel">&nbsp;</span>
						<input type="hidden" name="driver_age" value="30">
						<div class="relativemask"> <span class="maskimg caln"></span>
            ...
            <div class="col-md-1 col-xs-12 padfive">

				<div class="searchsbmtfot">

					<button class="searchsbmt comncolor">
				...
				<div class="col-xs-12 nopad marginbotom10 aftremarg">
					<div class="remove_age" id="remove_age">
					 <div class="squaredThree2">
						<input type="checkbox" name="driver_age_value" id='driver_age' value="30" checked="checked">
						<label for="driver_age_value"></label>
					 </div>
					 <label for="driver_age_value" class="lbllbl">Driver's age between 30 - 65</label>
					</div>
