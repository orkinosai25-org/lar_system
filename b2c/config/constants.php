...
define('CURRENT_DOMAIN_KEY', 'TMX1512291534825461'); // FIXME//Vc8Z7XLsyys9TEQdFPkV
...
define('PHONE', 'phone');
define('EMAIL', 'email');
define('HOTEL_CRS_IMAGE_UPLOAD_DIR', realpath('../extras') . '/custom/' . CURRENT_DOMAIN_KEY . '/uploads/eco_stays/stays/');
