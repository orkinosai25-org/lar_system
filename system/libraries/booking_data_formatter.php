...
class Booking_Data_Formatter {
	 ...
	 * @return number
	 */
	function display_currency_for_sightseeing($currency_rate = array(),$itinerary_details=array()){
		$conversion_rate = $currency_rate['currency_conversion_rate'];
	 ...
	 * @return number
	 */
	function display_currency_for_transferv1($currency_rate = array(),$itinerary_details=array()){
		$conversion_rate = $currency_rate['currency_conversion_rate'];
