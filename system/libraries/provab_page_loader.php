			...
			foreach ($this->config['form'][$name]['form_footer'] as $b_k => $b_v) {
				...
				switch ($key) {
					...
					case 'cancel' :
						...
						$b_id = $name.'_cancel';
						$b_label = (isset($b_v['lang_line_code']) && intval($b_v['lang_line_code']) > 0) ? $b_v['lang_line_code'] : 8;
						break;
					case 'cancel_op' :
						$b_type = 'button';
					...
					default :
						...
						$b_id = $name.'_custom';
						$b_label = (isset($b_v['lang_line_code']) && intval($b_v['lang_line_code']) > 0) ? $b_v['lang_line_code'] : 255;
						break;
				}
