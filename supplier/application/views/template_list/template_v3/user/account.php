              ...
              <div class="userfstep">
                ...
                <div class="tab-content">
                  <div role="tabpanel filldiv" class="tab-pane active" id="show_user_profile">
                    <div class="colusrdash"> <img src="<?= (empty($GLOBALS['CI']->entity_image) == false ? $GLOBALS['CI']->template->domain_images($GLOBALS['CI']->entity_image) : $GLOBALS['CI']->template->template_images('face.png')) ?>" alt="profile Image" /> </div>
                    <div class="useralldets">
                      ...
                      <div class="rowother"> <span class="far fa-user"></span> <span class="labrti">
                        ...
                        <?=(empty($agency_name) == true ? 'Agency Name' : $agency_name).' - '.$first_name?>
                        </span>
                       </div>
                      ...
                      <div class="rowother"> <span class="far fa-mobile"></span> <span class="labrti">
                        ...
                        <?=(($phone == 0 || $phone == '') ? '---':$country_code.' '.$phone)?>
                        </span>
                      </div>
                            ...
                            <div class="tnlepasport_b2b">
                              ...
                              <div class="lablmain ">
                                ...
                                <?php //debug($country_code_list);exit;?>
                                  <?=generate_options($country_code_list, (array)$form_data['country_code'])?>
                                </select>
                              </div>
                            </div>
                          </div>
