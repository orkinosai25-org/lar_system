            ...
            <div class="panel-title">
                <ul class="nav nav-tabs nav-justified master_tabs" role="tablist" id="myTab">
                    ...
                    <li role="presentation" class="<?php echo $tab1; ?>"><a id="fromListHead" href="#fromList"
                            aria-controls="home" role="tab" data-toggle="tab"> Create/Update Cancellation Policy </a></li>
                    <li role="presentation" class="<?php echo $tab2; ?>"><a href="#tableList" aria-controls="profile"
                            role="tab" data-toggle="tab">  Room Cancellation Policies
                        </a></li>
...
{
    return '<a role="button" href="' . base_url() . 'index.php/eco_stays/room_cancellation_policy/' . $room_origin . '/' . $id . '" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i>
