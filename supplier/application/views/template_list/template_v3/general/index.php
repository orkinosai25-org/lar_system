...
<script>
  ...
  $(".fa-plane").click(function(){
  	  document.location.href = 'index.php/general/index/flights?default_view=VHCID1420613784';
  });
  $(".fa-building").click(function(){
  	  document.location.href = 'index.php/general/index/hotels?default_view=VHCID1420613748';
  });
  $(".fa-bus").click(function(){
  	  document.location.href = 'index.php/general/index/buses?default_view=VHCID1433498307';
  });
  $(".fa-tree").click(function(){
  	  document.location.href = 'index.php/general/index/holidays?default_view=VHCID1433498322';
  });
</script>