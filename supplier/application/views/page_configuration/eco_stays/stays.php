...
$form_configuration['form']['stays'] = array(
    ...
    'sections' => array(
        array(
            'elements' => array('type', 'theme', 'host', 'name', 'description', 'amenities', 'country', 'city', 'address', 'latitude', 'longitude', 'country_code', 'phone', 'email', 'gst_number', 'expiry', 'ratings', 'image', 'video_link', 'display_on_home_page')
        ),
    ),
...
$form_configuration['form']['stays_edit'] = array(
    ...
    'sections' => array(
        array(
            'elements' => array('origin', 'type', 'theme', 'host', 'name', 'description', 'amenities', 'country', 'city', 'address', 'latitude', 'longitude', 'country_code', 'phone', 'email', 'gst_number', 'expiry', 'ratings', 'image', 'video_link', 'display_address', 'display_on_home_page')
        ),
    ),
