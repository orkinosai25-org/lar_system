...
$form_configuration['inputs'] = array(
    ...
    'type' => array('type' => 'select', 'source' => 'db', 'source_location' => 'db_cache_api::get_eco_stays_room_types', 'label_line_code' => 343, 'mandatory' => true),
    'name' => array('type' => 'text', 'label_line_code' => 344, 'mandatory' => true),
    'board_type' => array('type' => 'select', 'source' => 'db', 'source_location' => 'db_cache_api::get_eco_stays_board_types', 'label_line_code' => 284, 'mandatory' => false),
    ...
    'amenities' => array('type' => 'multipleselect', 'multiple' => true, 'source' => 'db', 'source_location' => 'db_cache_api::get_eco_stays_room_amenities', 'label_line_code' => 275, 'mandatory' => true),
...
$form_configuration['form']['rooms'] = array(
    ...
    'sections' => array(
        array(
            'elements' => array('type', 'name', 'board_type', 'description', 'max_adults', 'max_childs', 'policy', 'meal_type', 'extra_bed', 'amenities', 'quantity', 'status')
        ),
    ),
...
$form_configuration['form']['rooms_edit'] = array(
    ...
    'sections' => array(
        array(
            'elements' => array('origin', 'type', 'name', 'board_type', 'description', 'max_adults', 'max_childs', 'policy', 'meal_type', 'extra_bed', 'amenities', 'quantity', 'status')
        ),
    ),
