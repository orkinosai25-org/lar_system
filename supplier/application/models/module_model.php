...
Class Module_Model extends CI_Model
{
	 ...
	 * @param $module_origin
	 */
	  public function create_domain_module_map(int $domain_origin, int $module_origin): void{
        $domain_module_map=[];
	 ...
	 */
	  public function get_course_list(array|string $condition = ''): array
	{
		// $filter = '';
		$filter_condition = ' ';
...
/**
	 ...
	 */
	    public function unserialize_temp_booking_record(string $book_id, int $temp_book_origin): array
	{
