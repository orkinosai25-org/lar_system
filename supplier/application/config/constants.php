...
if (empty($project_parent_folder) == false) {
	...
	define('PROJECT_COOKIE_PATH', '/' . $project_parent_folder . '/supplier/');
} else {
	define('APP_ROOT_DIR', ''); //main folder which wraps complete application
	define('PROJECT_COOKIE_PATH', '/supplier/');
}


define('MODULE_ROOT_DIR', '/supplier'); //main folder which holds current module
define('PROJECT_URI', APP_ROOT_DIR . MODULE_ROOT_DIR);
define('PROJECT_COOKIE_NAME', 'supplier');
...
define('META_COMMUTE_COURSE', 'TMVIATID1527240212');
/*
 |--------------------------------------------------------------------------
...
define('PROVAB_COMMUTE_BOOKING_SOURCE', 'PTBSID0000000008');
/*
 |--------------------------------------------------------------------------
