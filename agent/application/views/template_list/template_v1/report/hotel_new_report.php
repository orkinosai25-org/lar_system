      ...
      <div class="panel_custom_heading">
         ...
         <div class="col-md-3 rprt_lft">
            ...
            <div class="dropdown">
               ...
               Hotel <i class="far fa-angle-down"></i>
               </button>
                            ...
                            <div class="dropdown-menu">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-check cstm_dat">
                                      <div class="col-xs-6">
                                        <label>From</label>
                                                                 <input type="text" id="from_date" name="from_date" class="form-control" placeholder="From Date" value="<?php echo $from_date; ?>">
                                      </div>
                                      <div class="col-xs-6">
                                        <label>To</label>
                                        <input type="text" id="to_date" name ="to_date" class="datepick form-control" placeholder="To Date" value="<?php echo $to_date; ?>">
                                      </div>
                                    </div>
                                </div>
                              </div>
...
<?php
function get_table(string $table_data, string $total_rows)
{
...
function get_accomodation_cancellation(string $courseType, string $refId): string
{
