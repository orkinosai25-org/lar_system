...
<form id="trasfer" name="car" autocomplete="off" action="<?=base_url()?>index.php/general/pre_car_search">
	<div class="tabspl forbusonly car_form">
		...
		<div class="outsideserach custom_divclass">
			<div class="clearfix"></div>
			<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 nopad cr_plce">
			<div class="col-sm-6 col-xs-6 padfive mobile_width br_rt">
            ...
            <!-- <div class="formlabel">&nbsp;</div> -->
				<div class="searchsbmtfot">
					<button class="searchsbmt comncolor"><i class="far fa-search"></i></button>
				</div>
			</div>
