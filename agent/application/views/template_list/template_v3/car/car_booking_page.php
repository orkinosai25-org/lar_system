               ...
               <div class="kindrest">
                  ...
                  <div class="reptallt">
                     <div class="col-xs-7 nopadding">
                        <div class="faresty">Pick Up Location<?=@$car_details['LocationDetails'][0]['@attributes']['Name'] ?></div>
                     </div>
                     <div class="col-xs-5 nopadding">
                        <div class="amnter"><?php echo $pickup_date_val.' '.$pickup_time_val; ?></div>
                     </div>
                  </div>
               </div>
               <div class="kindrest">
                  ...
                  <div class="reptallt">
                     <div class="col-xs-7 nopadding">
                        <div class="faresty">Drop Off Location<?=@$car_details['LocationDetails'][1]['@attributes']['Name'] ?></div>
                     </div>
                     <div class="col-xs-5 nopadding">
                        <div class="amnter"><?php echo $return_date_val.' '.$return_time_val; ?></div>
                     </div>
                  </div>
               </div>
               <?php 
        ...
        <div class="col-xs-12 nopadding">
          ...
          <div class="adult_in">
            ...
            <div class="pasngr_input pasngrinput _passenger_hiiden_inputs">
                    ...
                    <div class="clearfix"></div>
                    <div class="col-xs-3 pad_psger hide">
