		...
		<div class="allformst">
			...
			<div class="tab_border">
				...
				<li
						...
						href="#flight" aria-controls="flight" role="tab" data-toggle="tab"><img src="<?php echo $GLOBALS['CI']->template->template_images('m_flt_act.svg')?>" alt="flight"><label>Flights</label></a></li>
				<?php } ?>
				<?php if (is_active_hotel_module()) { ?>
				<li
						class="<?php echo set_default_active_tab(META_ACCOMODATION_COURSE, $default_active_tab)?>"><a
						href="#hotel" aria-controls="hotel" role="tab" data-toggle="tab"><img src="<?php echo $GLOBALS['CI']->template->template_images('m_htl.svg')?>" alt="flight"><label>Hotels</label></a></li>
				<?php } ?>
				...
				<li
						...
						href="#car" aria-controls="car" role="tab" data-toggle="tab"><img src="<?php echo $GLOBALS['CI']->template->template_images('m_car.svg')?>" alt="flight"><label>Cars</label></a></li>
				<?php } ?>
				...
				<li class=""><a href="#air_charter" aria-controls="air_charter" role="tab" data-toggle="tab"><img src="<?php echo $GLOBALS['CI']->template->template_images('m_air.svg')?>" alt="flight"><label>Air Charters</label></a></li>
					<?php } ?>
				</ul>
			  </div>
			</div>
