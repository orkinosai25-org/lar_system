...
foreach ($_RoomCombinations['RoomCombination'] as $__rc_key => $__rc_value) {
	...
	foreach ($current_combination_wrapper as $__room_index_key => $__room_index_value) {
		...
		data-room-price="'.$temp_price_details['RoomPrice'].'" data-room-amenties="'.base64_encode(json_encode($temp_room_details['Amenities'])).'" data-otherroom-amenties="'.base64_encode(json_encode($temp_room_details['OtherAmennities'])).'"
