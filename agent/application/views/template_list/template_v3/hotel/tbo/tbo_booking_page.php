	...
	<div class="pasngrinput _passenger_hiiden_inputs">
		...
		<div class="col-xs-12 nopadding">
		 ...
		 <div class="inptalbox">
		 	...
		 	<div class="clearfix"></div>
			<div class="col-xs-3 spllty hide">
			...
			<div class="col-xs-4 spllty"> 
				...
				<input type="text" name="middle_name[]" id="middle_name" class="clainput alpha_space last_name" minlength="2" maxlength="45" placeholder="Middle Name" value="" > 
			</div>
			<div class="col-xs-4 spllty">
...
function diaplay_phonecode($phone_code,$active_data, $user_country_code)
{
	...
	$list='<option value ="">Select Mobile Code</option>';
