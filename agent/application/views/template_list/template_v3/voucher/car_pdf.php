...
<table
	...
	<tbody>
	<tr><td style="padding: 10px;width:65%;"><span style="max-height: 56px" ><h4><i>Agency : <strong><?= $booking_details['domain_name']?></strong></i></h4></span></td></tr>
						...
						<td>
							<table width="100%" style="border-collapse: collapse;"
								...
								<tr>
									<td
										style="padding: 10px; border: 1px solid #cccccc;">
										<?php if(isset($extra_service_details) && valid_array($extra_service_details)){
