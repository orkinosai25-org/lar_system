               ...
               <table width="100%" style="border-collapse: collapse;" cellpadding="0" cellspacing="0" border="0">
                  ...
                  <tr>
                     ...
                     <td style="background: #F9F5F1;padding: 15px 15px;" colspan="2" align="right">
                        ...
                        <span style="font-size: 15px">GDS PNR:  </span><strong style="font-size: 15px;font-weight: 500"><?= @$gds_pnr ?></strong>
                        <?php } ?>
                        </span>
                     </td>
                     <?php } ?>
                           ...
                           <table width="100%" style="background: #F9F5F1">
                              <tr>
                                 <td style="text-align: left;padding: 5px 15px;"><span style="line-height: 18px;font-size: 13px;font-weight: 600;color: #3f3f3f;margin-right: 5px">Our Partners</span>
                                    <span style="background: #fff; border-radius: 3px; padding: 9px 15px; margin-right: 5px"><img style="height: 50px;" src="<?=$GLOBALS['CI']->template->template_images("booking_com.png");?>"></span>
                                    <span style="background: #fff; border-radius: 3px; padding: 9px 15px; margin-right: 5px"><img style="height: 50px;" src="<?=$GLOBALS['CI']->template->template_images("airbnb.png");?>"></span>
                                    <span style="background: #fff; border-radius: 3px; padding: 9px 15px; margin-right: 5px"><img style="height: 50px;" src="<?=$GLOBALS['CI']->template->template_images("expedia.png");?>"></span>
                                 </td>
