...
<div style="width:100%; position:relative; padding: 10px 0" id="tickect_hotel">
                                 ...
                                 <table width="100%" cellpadding="5" style="padding: 10px;font-size: 13px;padding:5px;">
                                    ...
                                    <tr>
                                       ...
                                       <td valign="top" style="padding:10px 20px 10px;width: 69%; position: relative;"><span style="line-height:30px;font-size:24px;line-height: 30px;color:#3F3F3F;vertical-align:middle;font-weight: 400;padding-bottom: 0;"><?php echo $booking_details['hotel_name']; ?></span><br>
                                          <span class="star_in"><i class="fas fa-star"></i><strong>5</strong></span><br>
   ...
   <table id="printOption"onclick="w=window.open();w.document.write(document.getElementById('tickect_hotel').innerHTML);w.print();w.close(); return true;"
      ...
      <tbody>
         <tr>
            <td align="center"><input style="background:#BF9766; height:34px; padding:5px 15px; border-radius:4px; border:none; color:#fff; margin:0 2px;" type="button" value="Print" />
         </tr>
      </tbody>
   </table>
</div>