...
function calendar_safe_search_data(array $search_data): array
{
    ...
    public function save_flight_booking_details(
		...
		$data = [
			...
			'status' => $flight_booking_data['flight_booking_status'],
			...
			'attributes' => $flight_booking_data['booking_details_attributes'],
   ...
   public function update_passenger_ticket_info(
    ...
    public function save_flight_booking_transaction_details(
		...
		$data = [
			...
			'status_description' => $transaction_det['transaction_description'],
			...
			'total_fare' => $transaction_price['commissionable_fare'],
			...
			'gst' => $transaction_price['gst_value'],
		];
	//debug($data);exit;
   ...
   public function save_flight_booking_itinerary_details(
		...
		$data = [
			...
			'status' => $flight_itinerary_det['iti_status'],
