...
$project_parent_folder = 'anitha_projects/lar_system_new';
...
if (empty($project_parent_folder) == false) {
	...
	define('PROJECT_COOKIE_PATH', '/'.$project_parent_folder.'/ultralux/');
} else {
	define('APP_ROOT_DIR', ''); //main folder which wraps complete application
	define('PROJECT_COOKIE_PATH', '/ultralux/');
}


define('MODULE_ROOT_DIR', '/ultralux'); //main folder which holds current module
define('PROJECT_URI', APP_ROOT_DIR.MODULE_ROOT_DIR);
define('PROJECT_COOKIE_NAME', 'ultralux');
...
/*
 ...
 |--------------------------------------------------------------------------
 */
define('UNIVERSAL_DEFAULT_CURRENCY', 'USD'); // INR
...
define('PROVAB_FLIGHT_CRS_BOOKING_SOURCE', 'PTBSID0000000112');
/*
 |--------------------------------------------------------------------------
