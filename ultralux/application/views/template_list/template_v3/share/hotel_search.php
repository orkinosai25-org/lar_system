	...
	<div class="tabspl forhotelonly">
		<div class="tabrow">
			...
			<div class="col-md-1 col-xs-12 nopad">
				<div class="col-md-3 col-sm-4 col-xs-4 mobile_width padfive br_rt hide">
				...
				<div class="col-md-5 col-sm-4 col-xs-4 mobile_width padfive hide">
				...
				<div class="col-md-12 col-sm-4 col-xs-4 mobile_width padfive">
					...
					<div class="searchsbmtfot">
						<input type="submit" id="hotel-form-submit" class="searchsbmt" value="" />
