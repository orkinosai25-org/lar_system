	...
	<div class="bktab2 xlbox <?=$travellers_tab_details_class?> d-block">
		...
		<div class="col-xs-4 rhttbepa">
			...
			<form name="promocode" id="promocode" novalidate>
									                    <div class="hide col-md-12 col-xs-12 nopadding_right pr_code nopad">
									                      <div class="cartprc">
	...
	<div class="pasngrinput _passenger_hiiden_inputs">
		...
		<div class="col-xs-12 nopadding">
		 ...
		 <div class="inptalbox">
			...
			<div class="col-xs-4 spllty"> 
				<label class="cst_lbl">Middle Name(Optional)</label>
				<input type="text" name="middle_name[]" id="middle_name_<?= $pax_index ?>" class="clainput alpha_space last_name" minlength="2" maxlength="45" placeholder="Middle Name" value="" > 
			</div>
			<div class="col-xs-4 spllty">
...
?>
				...
				<div class="clikdiv">
					 ...
					 <span class="clikagre">
					  By Clicking Continue Booking, I confirm that I have read and accept the <a href="<?php echo str_replace('/ultralux','',base_url());?>index.php/terms-conditions" target="_blank">Terms and Conditions</a> & <a href="<?php echo  str_replace('/ultralux','',base_url());?>index.php/privacy-policy" target="_blank">Privacy Policies</a>
					 </span>
				</div>
				<div class="clearfix"></div>
				<div class="loginspld">
