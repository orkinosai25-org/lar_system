                                 ...
                                 <table width="100%" cellpadding="5" style="padding: 10px;font-size: 13px;padding:5px;">
                                    ...
                                    <tr>
                                       <td style="border-top: 1.5px dashed color(srgb 0.87 0.69 0.2 / 0.5);padding-top:15px;font-size: 16px;line-height: 30px;">
                                          ...
                                          <span><?=@date("D, d M Y",strtotime($itinerary_details['check_in']))?></span>
                                       </td>
                                       <td style="border-top: 1.5px dashed color(srgb 0.87 0.69 0.2 / 0.5);padding-top:15px;text-align: right;font-size: 16px;line-height: 30px;">
                                          ...
                                          <span><?=@date("D, d M Y",strtotime($itinerary_details['check_out']))?></span>
                                       </td>
                                    </tr>
                                    </tbody>
                                 </table>
                                       ...
                                       <table cellspacing="0" cellpadding="5" width="100%" style="font-size:16px; line-height: 24px; padding:0;">
                                          <tbody>
                                            ...
                                            <?php } ?>
                                             ...
                                             <tr>
                                                <td style="border-top:1px solid #ccc;padding:12px 15px;"><span style="font-weight: 500; color: #525252">Total Fare</span></td>
                        ...
                        <td colspan="4" style="">
                           <table width="100%" style="background: #F9F5F1">
                            ...
                            ?>
                                 ...
                                 <td style="padding: 0 15px;font-weight: 500;font-size: 15px;" align="right">Luxury Africa Resorts
</td>
                              </tr>
                           </table>
                        </td>
...
document.getElementById('printBtn').onclick = function () {
    ...
    win.document.write('<style>body{font-family:Arial;} table{width:100%;} td, th{padding:8px;}</style>');
