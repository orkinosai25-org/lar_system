...
<?php } ?>
            ...
            <tr>
                <td colspan="4" align="right" style="padding-top:10px; line-height:16px"><?php echo strtoupper($data['domainname']) ?><br>ContactNo : <?php echo $data['country_code'] ?> <?php echo $data['phone'] ?><br><?php echo $data['address'] ?></td>
            </tr>
        </tbody>
    </table>
</div>
