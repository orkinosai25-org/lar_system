		...
		foreach ($cur_SegmentDetails as $__segment_k => $__segment_v) {
			...
			foreach ($__segment_v as $__stop => $__segment_flight) {
                ...
                <div class="layoverdiv">
                    <div class="centovr">
                    <span class="fa fa-plane"></span>Change Of Plane ' . $next_seg_info['OriginDetails']['CityName'].' - '.$waiting_time.' Layover
                </div></div>
                <div class="clearfix"></div>';
                }
			}
										...
										<div class="modal-content"> 
										  ...
										  <div class="modal-body">
												...
												<div class="form-group">
                                                 ...
                                                 <div class="text-center mail-loader-image" style="display: none;"><img src="' . $GLOBALS['CI']->template->template_images('loader_v3.gif') . '" alt="please wait"></div></div>
												</div>
