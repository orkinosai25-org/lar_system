...
//Segment Details
 $display_class = '';
            if($search_data['v_class'] == 'PremiumEconomy'){
                $display_class = 'Premium Economy';
            }else{
$display_class = $search_data['v_class'];

            }
$flight_segment_details = flight_segment_details($SegmentDetails, $SegmentSummary,$display_class);
...
<?php echo get_fare_summary($FareDetails); ?>
                    </div>
        ...
        <?php echo $flight_segment_details['segment_full_details']; ?>
                        ...
                        <div class="fligthsdets">
                             ...
                             * @param number $total_adult   total adult count
                             */
                            function is_adult($pax_index, $total_adult):bool {
                                                ...
                                                <div class="pasngr_input pasngrinput _passenger_hiiden_inputs">
                                                    ...
                                                    <div class="col-xs-12 nopadding full_dets_aps">
                                                        ...
                                                        <div class="clearfix"></div>
                                                            ...
                                                            <div class="col-xs-3 spllty">
                                                                <label class="cst_lbl">First Name</label>
                                                            ...
                                                            <div class="col-xs-3 spllty">
                                                                <label class="cst_lbl">Last Name</label>
...
?>
                                    ...
                                    <div class="contbk">
                                        ...
                                        <div class="col-xs-12 nopad full_smal_forty">
                                            ...
                                            <div class="col-xs-6 col-md-4 nopadding">
                                                ...
                                                <select name="phone_country_code" class="newslterinput nputbrd _numeric_only " >
                                    ...
                                    <div class="panel-group hide" role="tablist" aria-multiselectable="true">
...
<?php if (in_array(PAY_AT_BANK, $active_payment_options)) { ?>
                                    ...
                                    <div class="clikdiv">
                                        ...
                                        <span class="clikagre" id="clikagre">
                                            By Clicking Continue Booking, I confirm that I have read and accept the <a href="https://webapplar.azurewebsites.net/index.php/terms-conditions" target="_blank">Terms and Conditions</a> & <a href="https://webapplar.azurewebsites.net/index.php/privacy-policy" target="_blank">Privacy Policies</a>
                                        </span>
                                    </div>
                                    <div class="clearfix"></div>
...
function flight_segment_details($SegmentDetails, $SegmentSummary,$display_class) {
    ...
    foreach ($SegmentDetails as $__segment_k => $__segment_v) {
        ...
        $inner_summary .= $segment_summary['OriginDetails']['CityName'] . ' to ' . $segment_summary['DestinationDetails']['CityName'] . '<strong style="display:none">(' . $segment_summary['TotalDuaration'] . ')</strong>';
        $inner_summary .= '</div>';
        ...
        foreach ($__segment_v as $__stop => $__segment_flight) {
          $orgin_terminal = '';
            ...
            //airline
            $inner_summary .= '<div class="allboxfltin">';
            $inner_summary .= '<div class="col-xs-4 nopadding width_adjst">
									<div class="jetimg">
                                    ...
                                    <div class="clearfix"></div>
                                    <span class="airlblxl"><strong>Starts on - </strong> ' . month_date_year_new($__segment_flight['OriginDetails']['DateTime']) . '</span>
                                    <span class="flt_tim">'.local_time($__segment_flight['OriginDetails']['DateTime']).'</span>
                                    <span class="air_code d-block">' . $__segment_flight['OriginDetails']['AirportCode'] . '</span>
                                    <span class="portnme">' . $__segment_flight['OriginDetails']['AirportName'] . '</span>
                                    <p class="air_port">'. $__segment_flight['OriginDetails']['AirportCity'].', '.$__segment_flight['OriginDetails']['Country'].'</p>
                                    <span class="air_trm">'.$orgin_terminal.'</span>
								  </div>';
            //depart
            $inner_summary .= '<div class="col-xs-4 nopadding width_adjst">
            ...
            //Between Content -----
            $inner_summary .= '<div class="col-xs-4 nopadding width_adjst">
                                    <h5 class="text-uppercase">'.$display_class.'</h5>
                                    <span class="airlblxl"><strong>Arrive on - </strong> ' . month_date_year_new($__segment_flight['DestinationDetails']['DateTime']) . '</span>
                                    <span class="flt_tim">'.local_time($__segment_flight['DestinationDetails']['DateTime']).'</span>
                                    <span class="air_code d-block">' . $__segment_flight['DestinationDetails']['AirportCode'] . '</span>
                                    <span class="portnme">' . $__segment_flight['DestinationDetails']['AirportName'] . '</span>
                                  <p class="air_port">'. $__segment_flight['DestinationDetails']['AirportCity'].', '.$__segment_flight['DestinationDetails']['Country'].'</p>
                                    <span class="air_trm">'.$destination_terminal.'</span>
                                </div>
                                </div>
                                <div class="clearfix"></div>';
            $inner_summary .= '<div class="bag_detl">';
								if(empty($__segment_flight['CabinBaggage']) == false){
            $inner_summary .= '<span class="bg_cbn">Cabin : 7Kgs</span>';
								}
			$AvailableSeats = isset($__segment_flight['AvailableSeats']) ? $__segment_flight['AvailableSeats'] . ' ' : '';
            $inner_summary .= '<span class="bg_chkin">Check-In : '.$__segment_flight['Baggage'].'</span>';
			$inner_summary .= '<span class="bg_chkin avail_seats">Seats : '.$AvailableSeats.'</span>
                               </div>';                                
            //Summary of Way - End
            $inner_summary .= '</div>';
            if (isset($__segment_v['WaitingTime']) == true) {
                $next_seg_info = $SegmentDetails[$__segment_k + 1];
    ...
    foreach ($SegmentSummary as $__segment_k => $__segment_v) {
        $t_segment_duration = $__segment_v['TotalDuaration'];
        ...
        $outer_summary .= '<div class="col-xs-2 nopadding width_adjst">
                                <span class="portnme textcntr">' . ($t_segment_duration) . '</span>
...
function get_fare_summary($FareDetails) {
    ...
    $fare_summary = '<div class="insiefare">
                    ...
                    <div class="fredivs">';
    $hide_show_details = '<div class="kindrest">
    ...
    $extar_charge_details = '<div class="">';
    $extar_charge_details .= '<div class="baggagecharge-agent" id="extra_baggage_charge_label" style="display:none">
    ...
    $fare_summary .= $hide_show_details;
    ...
    $fare_summary .= $extar_charge_details;
