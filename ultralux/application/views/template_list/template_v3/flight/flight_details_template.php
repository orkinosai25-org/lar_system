...
.air_seat {
    ...
    float: left;
    margin-right: 0px;
    background: url("https://webapplar.azurewebsites.net/extras/system/template_list/template_v3/images/flight_seat.png") no-repeat 0 0 !important;
...
.suitcase{
    ...
    float: left;
    margin-right: 0px;
    background: url("https://webapplar.azurewebsites.net/extras/system/template_list/template_v3/images/baggage_icon.png") no-repeat 0 0 !important;
    background-position: 0px 0 !important;
}
.col-xs-5 {
    width: 41.66666667%;
					...
					<td width="100%" style="padding: 10px 10px 0; border:1px solid #ddd; border-bottom:none">
						...
						<tr>
							...
							<table  width="50%" align="left" border="0" cellpadding="0" cellspacing="0" class="devicewidth">
								...
								<tr>
									<td align="right">
										<div class="imgpop" style="float: left;padding: 5px 0px 5px 10;"><img src="https://webapplar.azurewebsites.net/extras/custom/TMX1512291534825461/images/TMX1512291534825461logo.png" width="150" height="50"></div>
    												...
    												<div class="allsegments <?php if($SegmentSummary_cnt==0){echo "segone";}else{echo "segtwo";}?>"><!--first section start-->
    													<div class="quarter_wdth nopad col-xs-3">
    														<div class="fligthsmll">
    															<img class="airline-logo" src="https://webapplar.azurewebsites.net/extras/system/library/images/airline_logo/<?=$value['AirlineDetails']['AirlineCode']?>.gif">
    														</div>
    													...
    													<div class="smal_udayp nopad col-xs-3">
    														<div class="insidesame">
    															...
    															<div class="stop_image">
    																<img src="https://webapplar.azurewebsites.net//extras/system/template_list/template_v3/images/<?=$stop_image?>">
    															</div>
    												...
    												<div class="priceanbook">
    													   <div class="insidesame">
    															<div class="priceflights">
    																<strong class="display_currency"><?php echo $flight_details['FareDetails']['b2b_PriceDetails']['CurrencySymbol']?></strong>
                    													...
                    													<div class="flitone"><!--filt first start-->
                    														<div class="col-xs-3 nopad5">
                    															<div class="imagesmflt">
                    																<img src="https://webapplar.azurewebsites.net/extras/system/library/images/airline_logo/<?=$value['AirlineDetails']['AirlineCode']?>.gif">
                    															</div>
                    														...
                    														<div class="col-xs-7 nopad5">
                    															...
                    															<div class="col-xs-4 nopad">
                    																<img src="https://webapplar.azurewebsites.net/extras/system/template_list/template_v3/images/frwdarrow.png" width="30" height="30">
                    															</div>
                    															<div class="col-xs-4 nopad5">
            ...
            <td><table width="700" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth2">
                ...
                <tr>
                    <td width="100%" style="padding: 10px 10px 0; border:1px solid #ddd; border-top:none">
                        ...
                        <tr>
                            <td align="left" valign="middle" style="color: #0545b2;font-family: arial;font-size: 12px;padding:22px 10px;text-align: left;" st-content="preheader"><a href="https://webapplar.azurewebsites.net/index.php/terms-conditions" style="text-decoration: underline; color: #0545b2">Terms & Conditions</a> </td>
            ...
            <td><table width="700" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth2"  bgcolor="#047297">
                ...
                <tr>
                    <td width="100%" style="padding: 10px 10px 0; border:1px solid #ddd; border-top:none"><table width="700" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth">
                        ...
                        <table width="35%" align="left" cellpadding="0" cellspacing="0" border="0">
                        <tr>
                            <td align="left" valign="middle" style="color: #666;font-family: arial;font-size: 12px;padding:22px 10px;text-align: left;" st-content="preheader"><span style="color: #fff"> Luxury Africa Resorts </span> </td>
