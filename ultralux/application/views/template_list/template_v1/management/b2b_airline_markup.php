         ...
         <div class="org_row">
            ...
            <div class="mrkup" id="selectedContent">
                           ...
                           <div class="row">
                              <div class="col-md-4">
                                 <div class="form-group">
                                    <label for="new_airline_value" class="col-sm-4 control-label">Airlines<span class="text-danger">*</span></label>
                                    <div class="col-md-8">
                              ...
                              <div class="col-md-4">
                                 <div class="radio pt-0 mrk_rad">
                                    <label for="value_type" class="col-sm-4 control-label nopad">Markup Type<span class="text-danger">*</span></label>
                              ...
                              <div class="col-md-4">
                                 <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                      <input type="text" id="new_airline_value" name="specific_value" class=" generic_value numeric form-control" placeholder="Markup Value" value="" />
                                    </div>
                                 </div>
                              </div>
                           </div>
                           ...
                           <div class="row ar_tbl">
                              ...
                              <div class="col-md-4">
                                 <div class="form-group mb-0">
                                    ...
                                    <input type="text" id="specific-value-<?=$__airline_index?>" name="specific_value[]" class=" specific-value numeric form-control" placeholder="Markup Value" value="<?=$__airline_record['value']?>" />
                                 </div>
                              </div>
                           </div>
                           <hr>
               ...
               <div class="tab-content  <?php if($page_type == 'flight_commission'){ echo 'active'; } ?>" id="com_flight">
				   <!-- HTML BEGIN -->
                <div class="bodyContent">
                	<div class="col-md-12 rprt_rgt mt-15"><!-- PANEL WRAP START -->
                		<div class="panel_bdy nopad"><!-- PANEL BODY START -->
                      <h3>Commission - Flight</h3>
                			<?php 
                				$flight_commission_details = $commission_details['flight_commission_details'][0];
                			?>
                			<div class="col-md-12 nopad cmsn"><h4><i class="fa fa-plane"></i> Flight Commission: <strong><?=$flight_commission_details['api_value']?> %</strong></h4></div>
                		</div><!-- PANEL BODY END -->
                	</div><!-- PANEL WRAP END -->
                </div>
               </div>
	...
	<div class="table_outer_wrper"><!-- PANEL WRAP START -->
		...
		<div class="panel_bdy"><!-- PANEL BODY START -->
			<fieldset><legend><i class="fa fa-hotel"></i> Hotel - Markup</legend>
                ...
                <div class="col-md-8">
  								<input type="text" id="hotel_generic_value" name="generic_value" class=" generic_value numeric form-control" placeholder="Markup Value" required="" value="<?=@$hotel_markup_list['generic_markup_list'][0]['value']?>" />
                </div>
							</div>
						</div>
					</div>
		...
		<div class="panel-body"><!-- PANEL BODY START -->
			<fieldset><legend><i class="fa fa-hotel"></i> Hotel - Specific Domain Markup</legend>
				...
				?>
                  ...
                  <div class="col-md-8">
  									<input type="text" id="hotel_specific-value-<?=$__doamin_index?>" name="specific_value[]" class=" specific-value numeric form-control" placeholder="Markup Value" value="<?=$__doamin_record['value']?>" />
                  </div>
								</div>
							</div>
						</div>
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="form-group">
								<label for="generic_value" class="col-sm-4 control-label">Markup Value<span class="text-danger">*</span></label>
                <div class="col-md-8">
  								<input type="text" id="generic_value" name="generic_value" class="form-control generic_value numeric" placeholder="Markup Value" required="" value="<?=@$car_markup_list['generic_markup_list'][0]['value']?>" />
                </div>
							</div>
						</div>
					</div>
...
<th>IFSC Code</th>
	...
	if (valid_array($table_data) == true) {
		...
		foreach ($table_data as $k => $v) {			
			...
			<td><img width="75px" src="'.$GLOBALS ['CI']->template->domain_images('bank_logo/'.$v['bank_icon']).'" alt="Bank Logo"></td>
