         ...
         <div class="org_row">
            <div class="col-md-3 rprt_lft">
               ...
               <div class="dropdown">
                  ...
                  Update Credit Limit <i class="far fa-angle-down"></i>
                  </button>
...
<div class="bodyContent">
	<div class="table_outer_wrper"><!-- PANEL WRAP START -->
		...
		<?php } //check if domain list is present - End IF?>
               ...
               <div class="tab-content active" id="pay_limit">
    ...
    <div class="col-md-9 rprt_rgt nopadL up_tab"><!-- PANEL HEAD START -->
        ...
        <div class="clearfix"></div>
          ...
          <div class="clearfix"></div>
          <div class="section_deposite fltr col-xs-12 mt-2">
					<?php
            ...
            <div role="tabpanel" class="tab-pane nopad <?php echo $tab2; ?> clearfix" id="tableList">
              <div class="col-md-9 rprt_rgt nopadL pull-right">
          			<form method="GET" autocomplete="off">
                  <h5>Filters:</h5>
                  <div class="fltr updt_blnc">
                    <div class="sml_row">
        ...
        <div class="up_tbl">
				<?php
					...
					echo get_table_credit_lmit($table_data);
					/************************ GENERATE CURRENT PAGE TABLE ************************/
				?>
        </div>
        </div>
...
<?php 
function get_table_credit_lmit($table_data='')
{
	$table = '
