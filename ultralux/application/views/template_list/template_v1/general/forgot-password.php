...
?>
<a class="handCursor " data-toggle="modal" data-target="#frgt" href="#" id="forgot-password">Forgot Password ? </a>
<!-- Modal -->
<div class="modal fade" id="frgt" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
