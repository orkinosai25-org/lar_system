         ...
         <?php if(isset($_HotelDetails['first_room_details'])&&empty($_HotelDetails['first_room_details'])==false):?>
	        <div class="htlfull_dtls">
	             <div class="htlamtnyt">
	             	...
	             	?>
	                <h2 class="amthtlrs hide"><strong> <?php echo $currency_obj->get_currency_symbol($currency_obj->to_currency); ?> </strong></i>&nbsp;<?=roundoff_number($per_night_price)?><span class="pernyt">/ Per Night</span></h2> 
				...
				<div class="detailtab fulldetab shdoww">
					...
					<?php if(valid_array($description)){ ?>
						...
						<h3 class="mobile_view_header">Description</h3>
							...
							<div class="lettrfty short-text"><ul>
