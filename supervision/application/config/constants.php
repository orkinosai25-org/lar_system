...
/*
 ...
 |--------------------------------------------------------------------------
 */
$project_parent_folder = 'LAR/lar_system_new';
...
define('IMG_NEWDIR', 'extras/custom');
...
define('HOTEL_CRS_VIEW_IMAGES', IMG_NEWDIR . '/' . CURRENT_DOMAIN_KEY . '/uploads/eco_stays/stays/');
...
define ('DOMAIN_PDF_DIR', '../extras/custom/'.CURRENT_DOMAIN_KEY.'/temp_booking_data_pdf/');
...
define('DOMAIN_HOTEL_PARTNER_UPLOAD_DIR', realpath('../extras').'/system/template_list/template_v3/images/hotel_partners');
define('DOMAIN_HOTEL_PARTNER_IMAGE_DIR', SYSTEM_RESOURCE_DIR.'/template_list/template_v3/images/hotel_partners/');
define('DOMAIN_AIRLINE_UPLOAD_DIR', CUSTOM_RESOURCE_DIR . '/' . CURRENT_DOMAIN_KEY . '/uploads/airline_img/');
/*
 |--------------------------------------------------------------------------
 | PAGE CONFIGURATION
 |--------------------------------------------------------------------------
...
/*
 ...
 |--------------------------------------------------------------------------
 */
define('UNIVERSAL_DEFAULT_CURRENCY', 'USD'); // USD
...
define('META_CRUISE_COURSE','TMCURISE1527240212');
define('META_AIRCHARTER_COURSE','TMAIRCHAR1527240212');
