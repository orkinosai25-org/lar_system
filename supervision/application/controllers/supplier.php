...
class Supplier extends CI_Controller {
	...
	public function view_packages_types(): void {
		$data=[];
	...
	public function add_package_type(int $id): void {
		$data=[];
		if (!empty($id)) {
	...
	public function save_packages_type(): void {
	...
	public function add_with_price(): void {
		$data=[];
	...
	public function add_package_new(): void {
		$photo = $_FILES;
	...
	public function edit_without_price(int $package_id): void {
		$data=[];
	...
	public function edit_itinerary(int $package_id): void{
		$data=[];
	...
	public function quesans_view(int $package_id): void {
		$data=[];
	...
	public function itinerary(): void {
	...
	public function itinerary_loop(int $duration): void {
		$data=[];
		$data ['duration'] = $duration;
		echo $this->template->isolated_view ( 'suppliers/duration_itinerary', $data );
	}
	public function itinerary_loop1(string $questions): void {
		$data=[];
		$data ['questions'] = $questions;
		$this->template->isolated_view ( 'suppliers/question', $data );
	}
	public function itinerary_loop2(int $pricee): void{
		$data=[];
		$data ['pricee'] = $pricee;
		$this->template->isolated_view ( 'suppliers/withprice', $data );
	}
	public function get_crs_city(int $city_id): void {
	...
	public function get_tour(int $tour_id): void {
		//$data=[];
		// echo "hi";
		// echo $tour_id;die;
	...
	public function edit_with_price(int $package_id): void {
		$data = [];
		$data ['packdata'] = $this->Supplierpackage_Model->get_package_id ( $package_id );
		$data ['price'] = $this->Supplierpackage_Model->get_price ( $package_id );
		$data ['countries'] = $this->Supplierpackage_Model->get_country_city_list ();
	...
	public function update_package(int $package_id): void {
		$name = $this->input->post ( 'name' );
		$location = $this->input->post ( 'location' );
		$description = $this->input->post ( 'Description' );
		$photo = $_FILES;
	...
	public function images(int $package_id): void {
		$data=[];
		//$traveller = [];
		if ($_FILES) {
			$tra = $_FILES;
	...
	public function view_enquiries(int $package_id): void {
		$data = [];
