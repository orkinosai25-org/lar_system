<?php
   ...
   if($booking_details['booking_source']=='PTBSID0000000011'){
     $currency_objd = new Currency ( array (
      ...
      //debug($currency_objd);die;
         $currency_conversion_rate1 = $currency_objd->getConversionRate();
         //debug($currency_conversion_rate1);die;
										...
										<tbody>
													...
													<table cellspacing="0" cellpadding="5" width="100%" style="font-size:12px; padding:0;border:1px solid #9a9a9a;">
														<tbody>
															...
															<tr>
																...
																<td style="padding:5px"><span><?php echo round($booking_details['fare']*$currency_conversion_rate1+$booking_details['admin_markup']+$booking_details['agent_markup']); ?></span></td>
															</tr>
															<tr>
                                            ...
                                            <?php } ?>
															...
															<tr>
																...
																<td style="border-top:1px solid #ccc;padding:5px"><span style="font-size:13px"><?php echo round($booking_details['grand_total']*$currency_conversion_rate1); ?></span></td>
															</tr>
														</tbody>
													</table>
												</td>
