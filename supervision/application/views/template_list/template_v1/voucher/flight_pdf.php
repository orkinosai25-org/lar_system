<?php 
   ...
   $airline_number = '<span><img style="vertical-align:middle" src='.base_url().SYSTEM_IMAGE_DIR.'phone.png /><span style="font-size:12pt;color:#00a9d6;vertical-align:middle;font-weight: 600;">'.$airline_contact_no['data'][0]['phone_number'].'</span></span> ';
   }
   else{
      $airline_number ='';
   }
...
<div style="background:#ccc; width:100%; position:relative">
   <table cellpadding="0" border-collapse cellspacing="0" width="100%" style="font-size:9pt;font-family: 'Open Sans', sans-serif; max-width:850px; margin:0px auto;background-color:#fff; padding:45px;border-collapse:separate; color: #000;">
      <tbody>
         <tr>
            <td colspan="2" valign="bottom" style="padding-bottom:10px;"><img style="width:150px;" src="<?=base_url().$GLOBALS['CI']->template->domain_images($data['logo'])?>" /></td>
         ...
         <tr>
            <td style="padding:10px 0; vertical-align:middle;"><img style="width:40px;" src="<?=base_url().SYSTEM_IMAGE_DIR.'airline_logo/'.$itinerary_details[0]['airline_code'].'.gif'?>" /></td>
         ...
         <tr>
            <td colspan="4" style="padding:0;">
               <table border="0" cellspacing="0" cellpadding="5" width="100%" style="border:1px solid #00a9d6;font-size:9pt; padding:0;">
                  <tbody>
                     <tr>
                     <td colspan="2" style="background-color:#00a9d6; color:#fff"><img width="9" src="<?=base_url().SYSTEM_IMAGE_DIR.'flight.png'?>"> &nbsp;<span style="vertical-align:middle;font-size:10pt">Onward Flight Details</span></td>                
                        ...
                        if (isset ( $booking_transaction_details ) && $booking_transaction_details != "") {
                              ...
                              foreach ( $itinerary_details as $segment_details_k => $segment_details_v ) { 
                                 ...
                                 if(in_array($segment_details_v['segment_indicator'], $seg_in_array) && !empty($seg_in_array) && ($seg_counts == 0) && ($trip_type != 'multicity')){ 
                                    ...
                                    ?>
                     <tr>
                        <td colspan="2" style="background-color:#00a9d6; color:#fff"><img width="9" src="<?=base_url().SYSTEM_IMAGE_DIR.'flight.png'?>"> &nbsp;<span style="vertical-align:middle;font-size:10pt">Return Flight Details</span></td> 
                        <td align="right" colspan="2" style="background-color:#00a9d6; color:#fff;line-height:normal;vertical-align:middle;"><span style="font-size:8pt;">*Please verify flight times with the airlines prior to departure</span></td>
                     </tr>
                     <?php }
...
# Checking Cabin Baggage
                     ...
                     <tr>
                        ...
                        <td style="background-color:#d9d9d9;color:#555555"><img width="15" style="vertical-align:middle" src="<?=base_url().SYSTEM_IMAGE_DIR.'flight_up.png'?>">&nbsp;<span style="vertical-align:middle">Departing</span></td>
                        <td style="background-color:#d9d9d9;color:#555555"><img width="15" style="vertical-align:middle" src="<?=base_url().SYSTEM_IMAGE_DIR.'flight_down.png'?>">&nbsp;<span style="vertical-align:middle">Arriving</span></td>
         ...
         <tr>
            <td colspan="4" style="padding:0;">
               <table cellspacing="0" cellpadding="5" width="100%" style="border:1px solid #666666;font-size:9pt; padding:0;">
                  <tbody>
                     <tr>
                        <td colspan="4" style="background-color:#666666; color:#fff"><img width="12" style="vertical-align:middle" src="<?=base_url().SYSTEM_IMAGE_DIR.'people_group.png'?>"> &nbsp;<span style="vertical-align:middle;font-size:10pt">Passenger(s) Details</span></td>
                     </tr>
                     <tr>
...
<?php if ($TotalBaggageCabin != '' && $TotalBaggageCabin != 0) { ?>
         ...
         <tr>
            <td colspan="4" align="right" style="padding-top:10px; line-height:16px"><?php echo strtoupper($data['domainname'])?><br>ContactNo :<?php echo $data['phone_code']?> <?php echo $data['phone']?><br><?php echo $data['address']?></td>
         </tr>
      </tbody>
   </table>
</div>
...
// debug($airline_contact_no);exit;
if(isset($airline_contact_no['data'][0])){
   $airline_number = '<span><img style="vertical-align:middle" src='.base_url().SYSTEM_IMAGE_DIR.'phone.png /><span style="font-size:16px;color:#00a9d6;vertical-align:middle;font-weight: 600;"> &nbsp;'.$airline_contact_no['data'][0]['phone_number'].'</span></span> ';
}
else{
   $airline_number ='';
}
...
<div style="background:#ccc; width:100%; position:relative">
   <table class="pag_brk" cellpadding="0" border-collapse cellspacing="0" width="100%" style="font-size:9pt; font-family: 'Open Sans', sans-serif; max-width:850px; margin:0px auto;background-color:#fff; padding:45px;border-collapse:separate; color: #000;">
      <tbody>
         ...
         <tr>
            <td style="padding:10px 0; vertical-align:middle;"><img style="width:40px;" src="<?=base_url().SYSTEM_IMAGE_DIR.'airline_logo/'.$return_segment_details[0]['airline_code'].'.gif'?>" /></td>
         ...
         <tr>
            <td colspan="4" style="padding:0;">
               <table border="0" cellspacing="0" cellpadding="5" width="100%" style="border:1px solid #00a9d6;font-size:9pt; padding:0;">
                  <tbody>
                     <tr>
                        <td colspan="2" style="background-color:#00a9d6; color:#fff"><img width="9" src="<?=base_url().SYSTEM_IMAGE_DIR.'flight.png'?>"> &nbsp;<span style="vertical-align:middle;font-size:10pt"><?php echo $Return;?>Flight Details</span></td>
                        <td align="right" colspan="2" style="background-color:#00a9d6; color:#fff;line-height:normal;vertical-align:middle;"><span style="font-size:8pt;">*Please verify flight times with the airlines prior to departure</span></td>
                     </tr>
                     <?php 
                        if (isset ( $booking_transaction_details ) && $booking_transaction_details != "") {
