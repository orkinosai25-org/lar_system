                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td class="center">
                                ...
                                <a class="" data-placement="top" title=""
                                  href="<?php echo base_url(); ?>index.php/supplier/view_enquiries/<?php echo $package->package_id; ?>/w"
                                  data-original-title="View Enquiries"><i class='glyphicon glyphicon-pencil'></i> Edit Enquiries 
                                </a><br>
                                <a href="<?php echo base_url(); ?>index.php/supplier/delete_package/<?php echo $package->package_id; ?>"
