            ...
            <div class="panel-title">
                <ul class="nav nav-tabs nav-justified master_tabs" role="tablist" id="myTab">
                    ...
                    <li role="presentation" class="<?php echo $tab2; ?>"><a href="#tableList" aria-controls="profile"
                            role="tab" data-toggle="tab"> hotel [
...
{
    return '<a role="button" href="' . base_url() . 'index.php/eco_stays/rooms/' . provab_encrypt($stays_origin) . '/' . provab_encrypt($id) . '" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i>
		' . get_app_message('AL0022') . '</a>';
}

function get_price_management_button($id)
{
    return '<a role="button" href="' . base_url() . 'index.php/eco_stays/room_price_management/' . provab_encrypt($id) . '" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i>
    ' . 'Price Management' . '</a>';
}
function get_cancellation_policy_button($id)
{
    return '<a role="button" href="' . base_url() . 'index.php/eco_stays/room_cancellation_policy/' . provab_encrypt($id) . '" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i>
...
{
    return '<a role="button" href="' . base_url() . 'index.php/eco_stays/room_availability_calendar/' . provab_encrypt($id) . '" class="btn btn-sm btn-primary"><i class="fa fa-calendar"></i>
...
$(document).ready(function(){
  ...
  $("#rooms_edit_cancel").click(function(){
    location.replace("https://www.travelsoho.com/LAR/supervision/index.php/eco_stays/stays");
  });
});
</script>
