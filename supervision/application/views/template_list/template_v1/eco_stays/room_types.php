            ...
            <div class="panel-title">
                <ul class="nav nav-tabs nav-justified master_tabs" role="tablist" id="myTab">
                    ...
                    <li role="presentation" class="<?php echo $tab2; ?>"><a href="#tableList" aria-controls="profile"
                            role="tab" data-toggle="tab"> Room List </a></li>
...
{
    return '<a role="button" href="' . base_url() . 'index.php/eco_stays/room_types/' . provab_encrypt($id) . '" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i>
		' . get_app_message('AL0022') . '</a>';
}

function get_delete_button($id)
{
    return '<a role="button" href="' . base_url() . 'index.php/eco_stays/delete_room_types/' . $id . '" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i>Delete</a>';
}
?>
...
$(document).ready(function(){
  $("#types_reset").click(function(){
    location.replace("https://www.travelsoho.com/LAR/supervision/eco_stays/room_types");
  });
  
  $("#types_edit_cancel").click(function(){
    window.location.href='https://www.travelsoho.com/LAR/supervision/index.php/eco_stays/room_types/';
    return false;
  });
