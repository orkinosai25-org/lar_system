			...
			<div id="show-search" class="collapse">
				<form method="GET" autocomplete="off">
					...
					<div class="col-sm-12 well well-sm">
						...
						<a href="<?php echo base_url().'index.php/report/b2b_package_report?' ?>" id="clear-filter" class="btn btn-primary">Clear Filter</a>
					</div>
				</form>
			</div>
		</div>
...
function get_package_table($table_data, $total_rows)
{
	...
	$report_data .= '<table class="table table-condensed table-bordered" id="b2b_report_package_table">
		<thead>
		<tr>
			<th>S.No</th>
			<th>Package Name</th>
