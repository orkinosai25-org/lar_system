...
foreach ($master_module_list as $k => $v) {
	...
	?>
		<li role="presentation" class="<?=$act_tab?>"><a href="<?=base_url()?>index.php/report/b2b_<?=($v).'_report'?><?= $append_query_string ?>"><i class="<?=get_arrangement_icon($k)?>"></i> <?='B2B '.$v.' Report'?></a></li>
	<?php
	}
}
