...
$form_configuration['inputs'] = array(
	...
	'user_type' 	   => array('type' => 'hidden',   'label_line_code' => 34, 'source' => 'db', 'source_location'  => 'db_cache_api::get_user_type', 'value' => 4)
);
...
'form_header' => $form_attributes,
		'sections' => array(
			array('elements' => array('user_id', 'title', 'first_name', 'last_name', 'date_of_birth', 'country_code', 'phone', 'address', 'status', 'language_preference','image'),
				'fieldset' => 'FFL003'
			),
