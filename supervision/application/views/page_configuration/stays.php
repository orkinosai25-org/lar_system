...
$form_configuration['inputs'] = array(
    ...
    'host' => array('type' => 'select', 'source' => 'db', 'source_location' => 'db_cache_api::get_suppliers', 'label_line_code' => 118, 'mandatory' => true),
    'name' => array('type' => 'text', 'label_line_code' => 183, 'mandatory' => true),
    'description' => array('type' => 'textarea', 'label_line_code' => 46, 'mandatory' => true),
    'amenities' => array('type' => 'select', 'multiple' => true, 'source' => 'db', 'source_location' => 'db_cache_api::get_eco_stays_amenities', 'label_line_code' => 275, 'mandatory' => true),
...
$form_configuration['form']['stays'] = array(
    ...
    'sections' => array(
        array(
            'elements' => array('type', 'theme', 'host', 'name', 'description', 'amenities', 'country', 'city', 'address', 'latitude', 'longitude', 'country_code', 'phone', 'email', 'gst_number', 'expiry', 'ratings', 'image', 'display_address', 'display_on_home_page', 'status')
        ),
    ),
...
$form_configuration['form']['stays_edit'] = array(
    ...
    'sections' => array(
        array(
            'elements' => array('origin', 'type', 'theme', 'host', 'name', 'description', 'amenities', 'country', 'city', 'address', 'latitude', 'longitude', 'country_code', 'phone', 'email', 'gst_number', 'expiry', 'ratings', 'image', 'video_link', 'display_address', 'display_on_home_page', 'status')
        ),
    ),
